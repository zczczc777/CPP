...
D:
cd C:\Users\Administrator\Desktop\PEPred_Suite
...
example.txt is the input sequence data, type has 10 options {AAP, ABP, ACP, AVP, AIP, CPP, QSP, SBP, ALL, OP}; confi is the confidence setting, the default is 0.5, the user can define, the range is 0~1 (do not need to be set when the type is OP);
